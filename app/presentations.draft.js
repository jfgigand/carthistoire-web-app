...
////  ZOOM BAR
  ...
  {"actions":[{"type":"ploomap.macro.action.LayerRunner","layer":"GEOGRAPHICALGRIDSYSTEMS.MAPS","opacity":1,"visibility":true,"defZIndex":true,"zIndex":52,"highlight":false,"remove":false},{"type":"ploomap.macro.action.LayerRunner","layer":"ORTHOIMAGERY.ORTHOPHOTOS","defZIndex":true,"zIndex":40,"highlight":false,"remove":false},{"type":"jig.macro.action.ScriptRunner","script":"\n  // déplacement de la loupe\nvar zoomBar = this.getUniqueWidgetByClass(\n       ploomap.OpenLayers.Control.SexyZoomBar);\n\nzoomBar.openMagnifier();\n/*zoomBar.magnifier.attr('value',\n  {layer:'ORTHOIMAGERY.ORTHOPHOTOS',\n   opacity:100,factor:0});\n*/\n//zoomBar.magnifier.attr('active', false);\n//zoomBar.magnifier.attr('active', true);\n\n//zoomBar.magnifier.move({x:700,y:400});\n\nvar duration = 50000;\nvar self = this;\nvar box = dojo.contentBox(this.mapWidget.map.div);\nvar w = box.w;\nvar h = box.h;\nvar nb = 30;\n\n(new dojo.Animation(\n {\n    curve: [0, 1],\n    //easing: dojo.fx.easing.sinInOut,\n    duration: duration,\n    onAnimate: function(v) {\n       // set\n       var x = parseInt(w * v);\n       var y = parseInt((Math.sin(v*nb)+1)*h/2);\n       zoomBar.magnifier.move({x:x,y:y});\n    },\n    onEnd: function() { self.onEnd(); }\n})).play();\n\n","scriptCallsOnEnd":true,"runnerClass":"ploomap.macro.action.MapBindingRunner"},{"type":"jig.macro.action.MacroRunner","terminate":true,"replay":false},{"style":{"fontSize":"1.5em"},"type":"jig.macro.action.TextRunner","text":"Loupe...","clear":false,"manualNext":true},{"type":"jig.macro.action.ScriptRunner","script":"\n  // déplacement de la loupe\nvar zoomBar = this.getUniqueWidgetByClass(\n       ploomap.OpenLayers.Control.SexyZoomBar);\n\nzoomBar.openMagnifier();\n//zoomBar.magnifier.move({x:700,y:400});\n\nvar duration = 50000;\nvar self = this;\nvar box = dojo.contentBox(this.mapWidget.map.div);\nvar w = box.w;\nvar h = box.h;\nvar nb = 30;\n\n(new dojo.Animation(\n {\n    curve: [0, 1],\n    //easing: dojo.fx.easing.sinInOut,\n    duration: duration,\n    onAnimate: function(v) {\n       // set\n       var x = parseInt(w * v);\n       var y = parseInt((Math.sin(v*nb)+1)*h/2);\n       zoomBar.magnifier.move({x:x,y:y});\n    },\n    onEnd: function() { self.onEnd(); }\n})).play();\n\n","scriptCallsOnEnd":true,"runnerClass":"ploomap.macro.action.MapBindingRunner"},{"style":{"fontSize":"1.2em"},"type":"jig.macro.action.TextRunner","text":"En 1:1","clear":true,"manualNext":true},{"type":"ploomap.macro.action.LayerRunner","layer":"ORTHOIMAGERY.ORTHOPHOTOS","defZIndex":false,"highlight":false,"remove":true}]}
