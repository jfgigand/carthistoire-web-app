...
dojo.declare('geonef.jig.macro.Editor', [ geonef.jig.layout._Anchor, dijit._Templated ],
{
  ...
  /*startup: function() {
    ...
    //console.log('startup ed', this, this.tabContainer);
    //window.setTimeout()
    //this.tabContainer.resize();
    //var c = dojo.coords(this.domNode);
    //window.setTimeout(dojo.hitch(this, 'resize', null, {w:c.w,h:c.h-10}, 'he'), 2000);
    //window.setTimeout(dojo.hitch(this, function() { this.resize(); }), 2000);
  },*/
