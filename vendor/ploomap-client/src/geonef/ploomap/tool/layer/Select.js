...
dojo.declare('geonef.ploomap.tool.layer.Select', geonef.ploomap.tool.layer.Simple,
{
  ...
  initWidget: function() {
    ...
    if (this.isBaseLayer) {
      ...
      dojo.addClass(this.labelNode, 'dojoDndHandle');
    }
    if (this.layer.group) {
  ...
  setCurrentLayer: function(layer) {
    ...
    //console.log('setCurrentLayer', layer.id);
