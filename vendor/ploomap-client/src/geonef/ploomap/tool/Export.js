             ...
             [ geonef.jig.layout._Anchor, dijit._Templated, geonef.ploomap.MapBinding ],
{
  ...
  getNoticeForLayer: function(layer) {
    return layer.CLASS_NAME === 'OpenLayers.Layer.Google' ?
      'Attention : l\'export des couches Google est limité à '+this.getMaxSizeForLayer(layer)+
  ...
  getUrlForLayer: function(layer, params, callback) {
    ...
    if (layer.pmExportMap) {
      ...
      console.log('mapName', this, mapName, layer.pmExportMap, res);
    ...
    if (layer.CLASS_NAME === 'OpenLayers.Layer.Google') {
      ...
      var zoom = layer.map.getZoomForResolution(resolution, true);
      var maptype = (
        function() {
