...
dojo.provide('cartapatate.start');
...
dojo.mixin(cartapatate.start,
{
  ...
  _initPackages: function() {
    if (window.devMode) {
      ...
      // dojo.registerModulePath('hurepoix', '/lib/hurepoix');
      dojo.registerModulePath('aire', '/lib/aire');
      // dojo.registerModulePath('histoire', '/lib/histoire');
      // dojo.registerModulePath('catapatate', '/lib/catapatate');
